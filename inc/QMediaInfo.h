...
typedef BOOL (*GETFILEINFO)(const wchar_t* strURL,Qvod_MainMediaInfo *pMainInfo);
typedef BOOL (*GETSTREAMINFO)(IAsyncReader *pReader,Qvod_MainMediaInfo *pMainInfo);
typedef BOOL (*GETFILEDETAILINFO)(const wchar_t *pReader,Qvod_DetailMediaInfo *pDetailInfo);
typedef BOOL (*GETFILELABEL)(const wchar_t* strURL,s_FileInfo *pLabelInfo);
typedef BOOL (*GETQMVINFOINTERFACE)(const wchar_t* strURL, interface IQMVDemuxFilter** ppqmvdemux, interface IVideoTagQuery** ppvideotgquery);
